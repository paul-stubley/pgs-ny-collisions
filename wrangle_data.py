...
def return_figures():
    ...
    """
    # Try to load the figures from the saved file
    try:
        figures = pickle.load(open("data/figures.pickle", "rb")) 
    ...
    # Otherwise create them fresh
        ...
        # Pickle the figures file for quicker use next time
        pickle_out = open("data/figures.pickle","wb")
        pickle.dump(figures, pickle_out)
        pickle_out.close()
